...
: ![Waterfall Design Process](waterfall.png)
...
* Tips:
    * Really just try to fuck shit up.
...
Event Class
: ![Event Class](class_design.png)

Wolf Scheduler Diagram
: ![Wolf Scheduler Diagram](full_class_diagram.png)
...
: ![Vending Machine Diagram](vending_machine_fsm.png)

* Compilation of code:

Pascal Real Constant Compiler
: ![Pascal Real Constant Compiler](pascal_compiler_fsm.png)

* Substring Finding:

Simple Text Processing for "abba"
: ![Simple Text Processing for "abba"](abba_fsm.png)

* Text Processing:

`wc` as a FSM
: ![`wc` as a FSM](wc_fsm.png)
