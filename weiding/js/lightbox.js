...
Lightbox.prototype = {
  ...
  resizeImageContainer: function (imgWidth, imgHeight, firstLoad = false) {
    ...
    if (hDiff != 0 || wDiff != 0)
      new Effect.Scale(this.outerImageContainer, [yScale, xScale], {
    ...
    (function () {
      ...
      // Need to subtract 20px to take in account the horizontal padding on the
      // imageDataContainer. Make sure this stays up to date with horizontal
      // padding on #imageDataContainer in lightbox.css.
      this.imageDataContainer.setStyle({ width: widthNew - 20 + "px" });
